...
// const nums1 = [11, 20, 345, 40, 52, true];
// const index1 = nums1.indexOf(3); // -1
// const index1 = nums1.indexOf(345); // 2 індекс
// const index1 = nums1.indexOf(true); // 5 індекс
// const index1 = nums1.indexOf(11, 2); // -1 
// const index1 = nums1.indexOf(345, 2); // 2 індекс 
// console.log("Приклад 1: Пошук елементу 3 в масиві");
// console.log("Індекс елементу:", index1); 

// const nums1 = [11, 20, 345, 40, 52, true];
// // const index1 = nums1.lastIndexOf(true); // індекс 5
// // const index1 = nums1.lastIndexOf(false); // -1
// // const index1 = nums1.lastIndexOf(true, 5); // 5
// // const index1 = nums1.lastIndexOf(true, -1); // 5 length-1
// // const index1 = nums1.lastIndexOf(52, -3); // -1 length-3
// const index1 = nums1.lastIndexOf(52, -2); // 4 length-2
// console.log("Приклад 1: Пошук останнього знаходження елемента 3 в масиві");
// console.log("Індекс останнього знаходження:", index1);

// const nums1 = [11, 20, 345, 40, 52, true];
// // const hasThree1 = nums1.includes(3); // false
// // const hasThree1 = nums1.includes(20); // true
// // const hasThree1 = nums1.includes(345,3); // false
// const hasThree1 = nums1.includes(345,2); // true
// console.log("Приклад 1: Елемент 3 є в масиві");
// console.log("Масив містить 3:", hasThree1); 

// const words = ["grape", "banana", "apple", "plum", "pineapple"];
// words.sort();
// console.log("Приклад 3: Сортування рядків");
// console.log("Відсортований масив:", words);

// const words = ["grape", "banana", "горобина", "гарбуз","apple", "plum", "pineapple"];
// words.sort();
// console.log("Приклад 3: Сортування рядків");
// console.log("Відсортований масив:", words);

// const nums1 = [1, 5, 3, 4, 2];
// const nums1 = [10, 5, 3, 40, 22, 21]; // [10,21, 22, 3, 40, 5]
// nums1.sort();
// console.log("Приклад 1: Сортування чисел як рядків");
// console.log("Відсортований масив:", nums1); 

// const nums1 = [10, 5, 3, 40, 22, 21];
// // nums1.sort((a, b) => a - b) // [ 3, 5, 10, 21, 22, 40]

// //          10 5     10-5 = +  [ 5, 10, 3, 40, 22, 21]
// //          10 3     10-3 = +  [ 5, 3, 10, 40, 22, 21]
// //          10 40    10-40 = -  [ 5, 3, 10, 40, 22, 21]
// //          40 22    40-22 = +  [ 5, 3, 10, 22, 40, 21]
// //          40 21    40-21 = +  [ 5, 3, 10, 22, 21, 40]
// //-----
// //          5 3    5-3 = +  [ 3, 5, 10, 22, 21, 40]
// //          22 21  22-21 = +  [ 3, 5, 10, 21, 22, 40]

// nums1.sort((a, b) => b - a) //  [40, 22, 21, 10, 5, 3]
// console.log("Відсортований масив:", nums1); 


// const nums1 = [10, 5, 3, 40, 22, 21]
// const nums1 = [ 3, 5, 10, 21, 22, 40]
// nums1.reverse() // [40, 22, 21, 10, 5, 3]
// console.log(nums1);
...
// const words = ["grape", "banana", "горобина", "гарбуз","apple", "plum", "pineapple"];
// let result = words.sort().reverse().filter((word)=> word[0] === 'p')
// console.log(result);

// isArray()
const arr1 = [1, 2, 3];
console.log(Array.isArray(345)); // false
console.log(Array.isArray(true)); // false
console.log(Array.isArray("Tea")); // false
console.log(Array.isArray({key: "value"})); // false
console.log(Array.isArray({key: "value", length:1})); // false
